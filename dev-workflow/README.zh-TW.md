...
| `skill-tasting` | `/skill-tasting` | 對既有 skill 進行輸出品質 A/B — 產生不同 output trait 的變體、盲測呈現、捕捉使用者偏好。Constitution 是底線、taste 是上限、preference log 累積成 RLHF-lite dataset（skill-evolution 的 Phase B）|
...
- `skill-tasting`（本 release，v1.7.0）處理 taste-sensitive 輸出
