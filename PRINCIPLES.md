...
2. Quality comes from machines, not from the user's sign-off: at least two fresh-context reviewers, a blind run by someone who did not write it, and an adversarial pass; every incident becomes a permanent eval.
