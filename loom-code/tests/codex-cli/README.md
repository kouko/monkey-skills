...
| Script | Tests | When |
|---|---|---|
| `test-skill-loading.sh` | Plugin installs cleanly; all 11 skills discoverable in the installed plugin cache | Run once after Codex CLI install + `codex plugin add loom-code@monkey-skills` |
...
# Remove flow:
codex plugin remove loom-code@monkey-skills
...
```bash
codex plugin list
# Shows: loom-code@monkey-skills  installed, enabled  0.16.0
```
...
loom-code router banner **verbatim** ("Router for loom-code —
...
# Confirm install:
codex plugin list
# expect: loom-code@monkey-skills  installed, enabled  0.16.0
```
...
bash loom-code/tests/codex-cli/test-hook-injection.sh
...
- [`../../skills/using-loom-code/references/codex-tools.md`](../../skills/using-loom-code/references/codex-tools.md) — Codex CLI tool surface reference.
