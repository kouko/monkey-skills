...
if echo "${PROBE_OUTPUT}" | grep -qE "Brainstorm|TDD|iron law|SDD|Never push without review|loom-code"; then
  ...
  echo "  Expected one of: Brainstorm / TDD / iron law / SDD / Never push without review / loom-code"
