...
Auto-invoked by `using-loom-code` whenever the user starts implementation work — feature, bug fix, refactor, migration. Also self-invoked by `subagent-driven-development` inside each implementer subagent.
...
- [`../using-loom-code/SKILL.md`](../using-loom-code/SKILL.md) — router; explains where this skill fits in the flow.
