...
**Correction (2026-08-22):** the counts in the corrections above are true as of their own dates. This file now holds 17 pointer sections; three arrived from `agents/docs-reviewer.md` when the contracts-cite-only-what-ships arc moved provenance out of that contract.
