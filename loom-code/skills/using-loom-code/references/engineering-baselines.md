...
The full text lives in [`loom-code/scripts/_baseline.md`](../../../scripts/_baseline.md).
...
loom-code in v0.5.2 (P15-12) as part of a broader move to
...
- [`loom-code/scripts/_baseline.md`](../../../scripts/_baseline.md)
  — the SSOT.
- [`loom-code/agents/implementer.md`](../../../agents/implementer.md)
...
- [`../../subagent-driven-development/SKILL.md`](../../subagent-driven-development/SKILL.md)
  ...
  `Agent({subagent_type: "loom-code:implementer"})`.
