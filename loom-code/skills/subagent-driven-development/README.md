...
| `code-quality-reviewer` | evaluator | PASS / PASS_WITH_NOTES / NEEDS_REVISION + eight-dimension scores + findings (🔴 / 🟡 / 🟢) | artifact, rubrics, checklist, 9 standards | verdict only |
