...
**Source brief**: docs/loom/specs/2026-05-16-toast.md
**Total tasks**: 4 (≤5 ✓)
...
writing-plans applies the splitting framework to Task 3. Produces child plan at `docs/loom/plans/2026-05-16-toast-part-3-children.md`:
