...
Graduated from docs/loom/2026-09-03-small-change-lane/evidence/probes/
test_abuse_change_lane.py, graduated 2026-09-04 (W0-01).
"""
...
def test_list_rules_prints_exactly_27_ids(tmp_path: Path) -> None:
    ...
    assert len(ids) == len(set(ids)) == 28, f"got {len(ids)} ids: {ids}"
