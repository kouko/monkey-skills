...
**Implementation complexity lens.** Compare the actual diff with optional planned complexity evidence; verify promised deletions landed, identify unplanned burden, and name a concrete smaller alternative for every finding. When evidence is absent, make an independent local assessment of downstream operational risk.
