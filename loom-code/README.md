...
⚠️ Codex CLI manifest is built and bumped through v0.20.0 alongside the
...
| **Codex CLI** | ⚠️ Manifest built + tracked at v0.20.0; live install + verification ritual deferred per user (see `tests/codex-cli/README.md`) |
