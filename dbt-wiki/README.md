...
| [`/dbt-wiki:update`](skills/update/) | "Just bring my wiki up to date" in one command | Runs `rescan`, then if knowledge pages went stale, gates an LLM `redistill` behind an explicit yes |
