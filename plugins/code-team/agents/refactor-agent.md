...
name: refactor-agent
description: >
  Mechanical refactoring executor. Performs well-defined
  structural transformations: extract function, rename across
  codebase, move module, convert patterns. Does NOT make
  design decisions — follows explicit instructions.
  Use when you have a clear refactoring plan to execute.
# Claude Code
model: sonnet
