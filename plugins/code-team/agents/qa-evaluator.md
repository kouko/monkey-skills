...
name: qa-evaluator
description: >
  Quality evaluator for code and content review.
  Use proactively after completing a feature, fixing a bug,
  or generating any substantial output that needs verification.
# Claude Code
model: opus
