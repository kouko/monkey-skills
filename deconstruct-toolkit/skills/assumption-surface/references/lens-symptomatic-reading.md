...
> **Source**: Louis Althusser & Étienne Balibar, *Reading Capital* (originally *Lire le Capital*, 1965 first edition with multiple contributors at Maspero Paris; abridged single-volume 1968 edition served as basis for most translations; English trans. Ben Brewster, NLB, 1970). The concept of **"symptomatic reading"** (*lecture symptomale*) is the book's central methodological innovation, introduced by Althusser in his contribution "From Capital to Marx's Philosophy" (Part 1, Ch 1 of the abridged edition). Symptomatic reading aims to produce the unstated question to which a text is an answer — making visible the writer's *unconscious problematic* by examining omissions and structural tensions. Note: the 1965 unabridged French edition contains contributions from Pierre Macherey, Roger Establet, and Jacques Rancière that were removed from the 1968 abridged edition (and subsequent translations); the *Reading Capital: The Complete Edition* (Verso, 2015) restores them. (Single-source lens — no synthesis disclosure applies.)
