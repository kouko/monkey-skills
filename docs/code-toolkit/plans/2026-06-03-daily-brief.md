...
Source brief: docs/code-toolkit/specs/2026-06-03-daily-brief-v0.1-brief.md
...
- Context paths:
  ...
  - docs/code-toolkit/specs/2026-06-03-daily-brief-v0.1-brief.md (the brief — SSOT)
...
- Context paths:
  ...
  - docs/code-toolkit/specs/2026-06-03-daily-brief-v0.1-brief.md §"每個平台的 canonical 深連結形式"
...
- Context paths:
  ...
  - docs/code-toolkit/specs/2026-06-03-daily-brief-v0.1-brief.md §"動態焦點規則" + §"文件累積 + 延續性模型"
- Acceptance:
...
- Context paths:
  ...
  - docs/code-toolkit/specs/2026-06-03-daily-brief-v0.1-brief.md §"Output Artifact Specs"
- Acceptance:
