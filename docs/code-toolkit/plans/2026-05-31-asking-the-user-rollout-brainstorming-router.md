...
Source brief: docs/code-toolkit/specs/2026-05-31-asking-the-user-rollout-brainstorming-router.md
...
- Context paths:
  - docs/code-toolkit/specs/2026-05-31-asking-the-user-rollout-brainstorming-router.md
...
- Description: Append a short "Cross-skill rollout" section to the existing concept-SSOT
  doc `docs/code-toolkit/specs/2026-05-31-asking-the-user-three-gate-redesign.md`,
...
- Module: docs/code-toolkit/specs/2026-05-31-asking-the-user-three-gate-redesign.md
- Files touched: docs/code-toolkit/specs/2026-05-31-asking-the-user-three-gate-redesign.md
- Context paths:
  - docs/code-toolkit/specs/2026-05-31-asking-the-user-rollout-brainstorming-router.md
