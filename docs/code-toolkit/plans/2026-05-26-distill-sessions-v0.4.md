...
**Source brief**: docs/code-toolkit/specs/2026-05-26-distill-sessions-v0.4-brief.md
**Total tasks**: 5 (≤5 ✓)
...
- **Context paths**:
  ...
  - `/Users/kouko/GitHub/monkey-skills/docs/code-toolkit/specs/2026-05-26-distill-sessions-v0.4-brief.md` (Q-v0.4-1 + Q-v0.4-2 lock + Sonnet literal verification)
- **Acceptance**:
...
- **Context paths**:
  ...
  - `/Users/kouko/GitHub/monkey-skills/docs/code-toolkit/specs/2026-05-26-distill-sessions-v0.4-brief.md` (§"What Becomes Obsolete" describes each prose-block change explicitly)
