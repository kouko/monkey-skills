...
- **Context paths**:
  ...
  - `/Users/kouko/GitHub/monkey-skills/docs/code-toolkit/specs/2026-05-25-distill-sessions-v0.3-brief.md` (canonical wording for the two fixes)
- **Acceptance**:
