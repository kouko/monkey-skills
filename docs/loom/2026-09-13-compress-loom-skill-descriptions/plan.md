...
- Files: docs/loom/evidence/mechanisms.yaml, loom-*/.claude-plugin/plugin.json, loom-*/.codex-plugin/plugin.json, loom-*/CHANGELOG.md, loom-*/README*.md, README*.md, loom-workflow/scripts/test_skill_count.py, loom-code/scripts/check_mechanisms.py, loom-code/scripts/test_check_mechanisms.py, loom-code/scripts/test_contract_manifest.py, loom-code/scripts/test_write_plan_station_text.py, loom-design/scripts/spec/test_capture_intent_contract.py, scripts/test_loom_plugin_install_layout.py, .claude-plugin/marketplace.json
