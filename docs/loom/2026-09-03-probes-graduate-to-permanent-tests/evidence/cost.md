...
| adversary (sonnet), 8 probes | 07:36 → 07:41 | 5 | ran in parallel with nothing; codex ping 1 min |
...
| review-only commit → push gate pass | 07:46 | 0 | lane recomputed `small` |
| **intent confirmed → push gate pass** | | **17** | Acceptance #4 bar: 20 |
