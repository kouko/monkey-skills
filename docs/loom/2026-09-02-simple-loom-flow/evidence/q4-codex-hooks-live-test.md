...
## Pre-1.0 record — Codex 0.139.0 repo-wide compat (2026-06-30)

Folded in at loom 1.0 from the former standalone `docs/loom/codex-verification.md`,
verbatim (headings demoted one level). It is the earlier half of the same question this
file answers — what Codex actually does on this repo, measured on a real CLI — recorded
against Codex 0.139.0 before the hooks test above was run on 0.151.0. Kept as a dated
record: version-specific findings below are not re-verified against 0.151.0.
