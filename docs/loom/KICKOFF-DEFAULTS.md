...
- second-vendor: codex — kouko wants to decide per change (`ask`), but the installed hook lags this branch's checker; flip to `ask` in the first change after loom-code 1.1.0 is installed (2026-09-04)
