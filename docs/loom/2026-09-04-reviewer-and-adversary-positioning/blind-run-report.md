...
- **結論**：works（附註）——兩個數字要分開看。**「是不是自己的」**：第三輪讀者 8/8、對抗者 8/8（2、3、6 全認領，其餘全讓出）——這是這條驗收原文「能正確分出哪些歸自己」問的事。**「不是自己的那幾條該歸誰」（三方歸屬）**：讀者 8/8、對抗者 6/8——原本卡住的第 3 條修好了、兩邊不再互踢，但第 4、5 條這次讓給了「實作者」而不是「讀者」。兩位讀者與一次獨立評估都判定三方歸屬不在這條驗收的範圍內（單讀一份契約本來看不到另兩個角色怎麼分，真實流程裡讀者是獨立派出的，它自己仍認領 4、5）；這個殘留記在下方「你可能還沒想到的事」，要變成保證得另開 intent。
