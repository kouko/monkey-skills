...
negative: 上傳雲端; 兒童聲音資料分享; 互動遊戲; 識字教學; 社群分享
# note: 上傳雲端/兒童聲音資料分享 must read as forbidden (privacy stance), not
# accepted behavior; 互動遊戲/識字教學/社群分享 are Scope-out items — presence
# means they leaked back in as an in-scope Product Principle.
