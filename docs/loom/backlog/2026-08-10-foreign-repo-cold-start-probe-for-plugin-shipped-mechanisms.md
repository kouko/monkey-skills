...
Closed by `codex/loom-plugin-specialization`: isolated copied-root tests now
execute packaged commands with siblings absent and mutation-probe no-op tools.
