...
的 MAU、留存、使用深度等營運指標如何被講成一則可讀的敘事，而不是只列數字。

尚未有具體設計；下一步是先確認哪些資料源已經在 data-markets 的 kpi-quarterly
/ kpi-topline-backfill pack 裡可用，再決定敘事層要長在 analysis-kpi 還是
report-kpi-tearsheet 哪一層。
