...
type: practice
sources:
  - resource: 2026-09-04/05 — #789 and #790 each went red on CI after branch-end (doc-citation check, a graduated probe calling `git show main:`); artifact-language-policy rehearsed in a depth-1 clone and chased two failures CI could never produce
---
