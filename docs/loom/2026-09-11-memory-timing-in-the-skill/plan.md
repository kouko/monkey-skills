...
- Risk: Agent-decided: the guard carries its own justification in the docstring and in every failure message — which is how the 2026-07 instruction and its test came to be removed together. What the matcher does is stated in that module and nowhere else, this plan included.
