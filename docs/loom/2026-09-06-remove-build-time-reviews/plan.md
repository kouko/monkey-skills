...
- Files: `loom-code/scripts/loom_checker.py`, `loom-code/scripts/test_loom_checker_intake.py`, `loom-code/contract/manifest.yaml`, `loom-code/contract/templates/plan.md`, `loom-code/contract/templates/spec-minimal.md`
