...
Source brief: docs/loom/specs/2026-06-13-purpose-fit-relevance-floor-lever.md
Total tasks: 5
...
- Context paths:
  ...
  - docs/loom/specs/2026-06-13-purpose-fit-relevance-floor-lever.md (Decision § for the four required instructions)
- Acceptance:
