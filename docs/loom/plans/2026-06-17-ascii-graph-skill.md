...
Source brief: docs/loom/specs/2026-06-17-ascii-graph-skill.md
...
- Context paths:
  - docs/loom/specs/2026-06-17-ascii-graph-skill.md (width policy)
- Acceptance:
...
- Context paths:
  - docs/loom/specs/2026-06-17-ascii-graph-skill.md
