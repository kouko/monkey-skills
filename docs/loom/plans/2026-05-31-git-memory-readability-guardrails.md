...
Source brief: docs/loom/specs/2026-05-31-git-memory-readability-guardrails.md
...
- Brief lives under `docs/loom/specs/` (brainstorming's hardcoded path) though the
