...
- Files touched: loom-code/skills/subagent-driven-development/SKILL.md, loom-code/scripts/test_sdd_progress_card_duty.py
- Context paths:
...
- Files touched: loom-code/skills/requesting-code-review/SKILL.md, loom-code/scripts/test_review_stage_flip_duty.py
- Context paths:
