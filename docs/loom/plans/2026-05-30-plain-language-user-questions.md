...
**Source brief**: docs/loom/specs/2026-05-30-plain-language-user-questions-brief.md
**Total tasks**: 4 (≤5)
...
- Context paths:
  - docs/loom/specs/2026-05-30-plain-language-user-questions-brief.md (the 7-rule table + grounding)
...
- Context paths:
  ...
  - docs/loom/specs/2026-05-30-plain-language-user-questions-brief.md
...
- Context paths:
  ...
  - docs/loom/specs/2026-05-30-plain-language-user-questions-brief.md (evidence to cite in the entry)
- Acceptance:
