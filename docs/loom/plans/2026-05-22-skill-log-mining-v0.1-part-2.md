...
- **Context paths**:
  - `/Users/kouko/GitHub/monkey-skills/docs/loom/specs/2026-05-22-skill-log-mining-research.md` (§"Deep dive: Trace2Skill — our architecture template" — prompt design constraints + Memory Item schema)
...
- **Context paths**:
  ...
  - `/Users/kouko/GitHub/monkey-skills/docs/loom/specs/2026-05-22-skill-log-mining-v0.1-brief.md` (Q4 — SKILL.md only; `requires_new_reference_file: true` deferral marker)
- **Acceptance**:
...
- **Context paths**:
  ...
  - `/Users/kouko/GitHub/monkey-skills/docs/loom/specs/2026-05-22-skill-log-mining-v0.1-brief.md` (Decision §"No silent writes")
  - `/Users/kouko/GitHub/monkey-skills/docs/loom/specs/2026-05-22-skill-log-mining-research.md` (§"Deep dive: claude-coach Guardrails — `no silent writes`")
- **Acceptance**:
