...
**Source brief**: docs/loom/specs/2026-05-22-skill-log-mining-v0.1-brief.md
**Total tasks**: 5 (≤5 ✓)
...
- **Context paths**:
  ...
  - `/Users/kouko/GitHub/monkey-skills/docs/loom/specs/2026-05-22-skill-log-mining-research.md` (§"Cross-agent compatibility — two-layer split" for schema verification)
...
- **Context paths**:
  ...
  - `/Users/kouko/GitHub/monkey-skills/docs/loom/specs/2026-05-22-skill-log-mining-research.md` (§"Facets schema (per session, confirmed)")
- **External surfaces**:
...
- **Context paths**:
  ...
  - `/Users/kouko/GitHub/monkey-skills/docs/loom/specs/2026-05-22-skill-log-mining-research.md` (§"Mining demo findings" Pattern 1-4 detail)
- **Acceptance**:
...
- **Context paths**:
  ...
  - `/Users/kouko/GitHub/monkey-skills/docs/loom/specs/2026-05-22-skill-log-mining-research.md` (§"Deep dive: crune — prioritization layer" for reusability formula; §"Mining demo findings Pattern 1-4" + Q5 for `min_session_count` / `cross_project_count`)
- **Acceptance**:
