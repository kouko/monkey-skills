...
**Source brief**: docs/loom/specs/2026-05-27-distill-sessions-v0.5-brief.md
**Total tasks**: 5 (≤5 ✓)
...
- **Context paths**:
  ...
  - `/Users/kouko/GitHub/monkey-skills/.claude/worktrees/distill-sessions-v0.5/docs/loom/specs/2026-05-27-distill-sessions-v0.5-brief.md`
- **Acceptance**:
