...
**Source brief**: docs/loom/specs/2026-05-27-distill-sessions-v0.4.1-brief.md
**Total tasks**: 3 (≤5 ✓)
...
- **Context paths**:
  ...
  - `/Users/kouko/GitHub/monkey-skills/docs/loom/specs/2026-05-27-distill-sessions-v0.4.1-brief.md` (§Decision + Q-v0.4.1-1 to Q-v0.4.1-5 lock decisions)
- **Acceptance**:
...
- **Context paths**:
  ...
  - `/Users/kouko/GitHub/monkey-skills/docs/loom/specs/2026-05-27-distill-sessions-v0.4.1-brief.md` (§"What Becomes Obsolete" → "Updated on v0.4.1 ship" lists exact edit locations)
- **Acceptance**:
