...
- BI-3 — `loom-code/agents/code-reviewer.md` carries one reviewer-lens sentence for the rule, and states in the same edit which document classes it does not reach.
