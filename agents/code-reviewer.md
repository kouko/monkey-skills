---
name: code-reviewer
description: 'Focused code reviewer for pull requests and code changes. Use after implementing features or fixing bugs to get a second opinion on code quality.

  '
---
# Agent (Compatibility Mode: Supports Claude Code & Gemini CLI)

# Code Reviewer (Compatible Mode)
Note: Simplified frontmatter to support both Claude Code and Gemini CLI.
