...
description: 'Lightweight summarizer for processing notes, daily journals, and vault content. Use when you need to compress information before passing to other agents or the main conversation.
