---
name: design-visual-reviewer
description: 'Visual and graphic design reviewer. Evaluates visual expression: composition, typography, color theory, brand consistency, and craft quality. Covers both digital product visuals AND graphic design (posters, brand materials, marketing assets). Use after creating visual designs, brand materials, or UI visual specs. Can review images directly.
