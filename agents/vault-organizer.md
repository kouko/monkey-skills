...
description: 'Obsidian vault maintenance agent for file organization, broken link detection, and metadata cleanup. Use for periodic vault hygiene or when reorganizing content.
