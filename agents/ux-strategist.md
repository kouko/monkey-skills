...
name: ux-strategist
description: >
  UX strategy reviewer evaluating user experience across the
  full product lifecycle — before, during, and after use.
  Combines Ando's temporal UX model with Garrett's Strategy ×
  Scope layers to assess business-user alignment per phase.
  Use after defining product strategy, user journeys, or value
  propositions to review whether the experience solves the
  right problem for the right audience.
# Claude Code
model: opus
