...
> ⚠️ **Cowork compatibility**: Claude Code CLI / Code tab only. Cowork tab is blocked by sandbox URL allowlist for external data fetches. Full retrospective: [`docs/mcp-setup.md`](docs/mcp-setup.md).
