...
OPTIONAL_SKILLS = ["analysis-comps", "analysis-xval", "analysis-kpi"]
...
def test_skill_count_pr1_floor():
    ...
    # Total is 11 (PR 1), 12 (analysis-comps), 13 (analysis-xval), 14 (analysis-kpi)
    assert len(expected) in (11, 12, 13, 14), (
