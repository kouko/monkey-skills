...
```json
{
  ...
  "signals": {
    ...
    "trend_alignment": "Strong Bullish",
...
| %B > 1.0 | Above Upper | Statistically extended |
| %B < 0.0 | Below Lower | Statistically compressed |
| close > SMA20 > SMA50 > SMA200 | Strong Bullish | Full uptrend stack |
