...
| `nbs-tree-monthly.md` | Full monthly indicator tree (14 categories, ~600 leaves), name + UUID |
| `nbs-tree-quarterly.md` | Full quarterly indicator tree (8 categories, ~120 leaves) |
| `nbs-tree-yearly.md` | Full yearly indicator tree (28 categories, ~2200 leaves) |
