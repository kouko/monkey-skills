...
| [`goal-create`](skills/goal-create/) | Create a goal condition — SESSION activates its four-field condition when supported and gives an honest manual command otherwise; ARC drafts the repository purpose artifact (`Why` / `Done when`). |
