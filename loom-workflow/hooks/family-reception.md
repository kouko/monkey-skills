...
SSOT: scripts/canonical/loom-family/family-reception.md
...
| 6 | The effort spans multiple sessions AND the route is foggy (open questions cannot all be phrased yet) | Suggest detouring to charting via **loom-workflow:decision-map** before brainstorming a single brief |
