...
The skill is **fully self-contained** — `loom-workflow` is the only
...
## Where in loom-workflow does this fit?

The "critique" line in loom-workflow now reads:
...
joshuadavidthomas/agent-skills (MIT, original)
  → softaworks/agent-toolkit/skills/reducing-entropy (MIT, fork)
    → kouko monkey-skills/loom-workflow/complexity-critique (this)
```
...
MIT — see [repository root LICENSE](https://github.com/kouko/monkey-skills/blob/main/LICENSE) and the
