...
- [x] Skill folder scaffolded: `loom-workflow/skills/brief-before-asking/`
...
Goal: build a `test-prompts.json` for repeatable evaluation. Pattern follows existing loom-workflow skills (see `skill-creator-advance/test-prompts.json`).
...
- [ ] Add to `loom-workflow/README.md` skills table (currently lists 7 skills; brief-before-asking becomes #8)
...
- [ ] Consider whether `loom-workflow:complexity-critique` should reference brief-before-asking (when complexity critique surfaces a fork, that fork may need briefing)
- [ ] Add to `loom-workflow/CHANGELOG.md`
...
- [ ] Commit messages should follow project convention (see existing commits on loom-workflow skills)
...
- Skill source: `loom-workflow/skills/brief-before-asking/SKILL.md`
- Design rationale: `loom-workflow/skills/brief-before-asking/references/DESIGN.md`
- Worked examples: `loom-workflow/skills/brief-before-asking/references/EXAMPLES.md`
- Anthropic skill conventions: project `CLAUDE.md` (root)
- Test prompts pattern: `loom-workflow/skills/skill-creator-advance/test-prompts.json`
