...
description: |
  Adapt a strategy artefact's framing to an executive's planning style (Gods/Gamblers/Grinders/Guides) without changing the analysis. Use for 'CEO discarded the plan', 'adapt the deck for the exec', or a leader rejecting scenario planning.
