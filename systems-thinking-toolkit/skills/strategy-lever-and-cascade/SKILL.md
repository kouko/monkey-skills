...
description: |
  Turn an ambition/outcome into actionable levers: split levers vs outcomes, diagnose the three-timescale cascade, build a scenario × lever table (robust/contingent/bet). Use for 'achieve X%', 'set the KPIs', '5-year plan', or OKR critique.
