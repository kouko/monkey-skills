...
name: cld-archetypes
description: |
  Given an R/B-annotated CLD (from cld-craft), name the archetype — limits-to-growth or variance/target/action — and apply the intervention. Use for 'growth is decelerating', 'diminishing returns', 'metric keeps swinging', or 'act now or wait?'.
