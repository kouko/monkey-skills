...
name: cld-craft
description: |
  Draw and classify a causal loop diagram (CLD): hygiene rules, soft variables as nodes, S/O link signs, R/B loop labels → annotated Mermaid CLD. Use when mapping a system, 'draw the CLD', 'how do these connect', or naming a feedback/vicious cycle.
