...
4. **Brief before you ask a complex fork.** Before you ask the user a design fork this complex — **≥3 trade-offs, ≥2 implementation paths, or architectural blast radius** — run `dev-workflow:brief-before-asking` first instead of improvising the question.
