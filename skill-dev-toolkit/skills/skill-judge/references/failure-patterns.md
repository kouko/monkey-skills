...
> Companion to [`../SKILL.md`](../SKILL.md). Load at Step 5 (report
> generation) when diagnosing WHY a dimension scored low and prescribing
> the fix — each pattern is symptom → root cause → fix.
