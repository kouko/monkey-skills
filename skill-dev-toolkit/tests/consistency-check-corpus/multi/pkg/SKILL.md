...
This creates a `.skill` file that can be shared and installed. The packager depends on Claude Code's local toolchain, so on Claude.ai skip this step and point the user at the finished skill folder instead.
