...
| [`loom-workflow`](loom-workflow/) | 1.2.2 | 11 | 4 | Loom workflow skills for git-backed project memory, decision briefs, critique, recap, handoff, session distill, `goal-create`, and `independent-advisor` cross-executor second opinion. |
