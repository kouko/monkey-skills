...
| [`loom-workflow`](loom-workflow/) | 3.1.0 | 12 | 4 | Loom workflow skills for git-backed project memory, decision briefs, critique, recap, handoff, session distill, `goal-create`, `independent-advisor` cross-executor second opinion, and long-term Outcome Maps spanning multiple delivery arcs. |
