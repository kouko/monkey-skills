...
- **License**：MIT（plugin code）+ bundled glossary 採逐筆 license（CC-BY-3.0 / CC-BY-4.0 / CC-BY-SA-4.0 / public-domain — 詳見 `NOTICES.md`）
- **Stability**：Pre-release。Skill skeletons 將於 v0.1.0 plan 的後續 task（A2-A5）登場。
...
- Glossary licensing ledger：`NOTICES.md`（task A2 加入）
