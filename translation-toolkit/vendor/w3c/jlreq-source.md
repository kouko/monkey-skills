# jlreq — Requirements for Japanese Text Layout (extracted source)

Source: https://www.w3.org/TR/jlreq/
Repo:   https://github.com/w3c/jlreq
License: W3C Document License (see LICENSE)
Extract date: 2026-05-06

This file is a manually extracted subset of the W3C jlreq specification,
focused on rules that affect translation output (punctuation choice,
spacing, line-breaking constraints, ruby). It is NOT a complete
reproduction; consult the canonical URL above for the full normative
text, especially when implementing a layout engine.
...
- W3C jlreq Working Draft: https://www.w3.org/TR/jlreq/
- jlreq-d (digital subset): https://www.w3.org/TR/jlreq-d/
- JIS X 4051 — 日本語文書の組版方法 (parent national standard).
- JIS Z 8301 — 規格票の様式 (technical-document spacing rules).
