...
| [`loom-workflow`](loom-workflow/) | 3.2.0 | 12 | 4 | git ベースの project memory、意思決定 brief、critique、recap、handoff、session distill、`goal-create`、`independent-advisor` によるクロス executor のセカンドオピニオン、複数のデリバリーアークにまたがる長期 Outcome Map 向けの loom workflow skills。 |
