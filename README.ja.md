...
> 個人用 Claude Code plugin marketplace — domain-team workflow、skill 開発、哲学的思考、Obsidian、投資、copywriting、slides、書籍 distillation、コードリポジトリナレッジ、制作物脱構築を網羅した 10 個の plugin。
