...
- **Any maestro added to `standards/voice-anchor-meta.md §Cross-Master Context` or `standards/voice-anchor-meta.md §Cross-Master Context` §Per-master sections in future versions** — the restricted list tracks the lineage standards' per-master coverage, not a static name list.
