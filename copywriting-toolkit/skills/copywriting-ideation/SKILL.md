...
description: |
  Brainstorm creative angles, headlines, concepts (曼陀羅 + Verbalized Sampling), converge via KJ法. Use after intake confirms an envelope, before a direction is chosen; skippable if direction is set. Raw 'brainstorm taglines' → using-copywriting-toolkit.
---
