...
- **zh-TW craft-gate** (許舜英 / 李欣頻 / 葉明桂): routed via `voice-anchor-meta.md §Cross-Master Context (ZH)`
...
- **中興百貨 brand-era → 許舜英** — load `voice-anchor-meta.md §Cross-Master Context` §許舜英
  - Slug: `zh-tw-zhongxing-xusunying-ideology-era` (brand-era label preserved; craft-gate is the actual voice anchor)
- **誠品書店 brand-era → 李欣頻** — load `voice-anchor-meta.md §Cross-Master Context` §李欣頻
  - Slug: `zh-tw-eslite-lixinping-literary-bookstore`
- **左岸咖啡館 brand-era → 葉明桂** — load `voice-anchor-meta.md §Cross-Master Context` §葉明桂
...
- **v1.6.0** (this file): 7 individual-creator entries moved to flat `anchor-*.md`; 3 brand-era entries collapsed to craft-gate pointers (許舜英 / 李欣頻 / 葉明桂 already in voice-anchor-meta.md §Cross-Master Context)
