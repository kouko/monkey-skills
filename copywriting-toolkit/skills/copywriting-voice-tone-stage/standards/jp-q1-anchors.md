...
**Inclusion criterion reminder** (v2): voice anchor = individual creator. Institutional / rotating-author newspapers + magazines + wire services have migrated to `docs/anchor-references/` as format references; Pass 3 does NOT load them as voice anchors.
...
- 朝日新聞「天声人語」rotating 論説委員 → [../../../../docs/anchor-references/jp-tensei-jingo-compressed-essay.md](../../../../docs/anchor-references/jp-tensei-jingo-compressed-essay.md)
- 東洋経済 / 日経ビジネス rotating editorial → [../../../../docs/anchor-references/jp-toyo-keizai-nikkei-analytical-editorial.md](../../../../docs/anchor-references/jp-toyo-keizai-nikkei-analytical-editorial.md)
...
**Moved out to format templates** (v1.6.0):
- ロイター日本語版 wire format → [../../../../docs/anchor-references/jp-reuters-wire-zero-warmth.md](../../../../docs/anchor-references/jp-reuters-wire-zero-warmth.md)
- 日経新聞 社説 / 春秋 policy-editorial format → [../../../../docs/anchor-references/jp-nikkei-shasetsu-policy-editorial.md](../../../../docs/anchor-references/jp-nikkei-shasetsu-policy-editorial.md)
...
- **v1.5.0**: Phase A Layer 1 v2 rewrites for 夏目漱石 / 伊丹十三 in `docs/voice-anchor-notes/` (was `docs/voice-anchor-deep-dives/` pre-v1.13.1)
- **v1.6.0** (this file): 2 individual-creator v2 entries moved to standards/ as flat `anchor-*.md`; 4 institutional/wire entries moved to `docs/anchor-references/`; this file becomes router index
