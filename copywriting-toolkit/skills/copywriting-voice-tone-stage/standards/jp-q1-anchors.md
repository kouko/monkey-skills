...
### JP Q1 center — individual creators

zh-TW Q1 currently thin on native individual creators. Main Q1-center option routes via individual-author anchors in toward-Q2 / toward-Q4 edges below; use this layer for 制度的 authority brief where `institutional-intelligent` register is pulled from toward-Q2 register.
