...
- クックパッド「つくれぽ」文化 UGC → [../../../../docs/format-templates/jp-cookpad-tsukurepo.md](../../../../docs/format-templates/jp-cookpad-tsukurepo.md)
...
**Moved out to format templates** (v1.6.0):
- 通販生活「カテゴリーにつき一点主義」→ [../../../../docs/format-templates/jp-tsuhan-seikatsu-ipponshugi.md](../../../../docs/format-templates/jp-tsuhan-seikatsu-ipponshugi.md)
...
**Moved out to format templates** (v1.6.0):
- ワークマン SNS era アンバサダーマーケティング → [../../../../docs/format-templates/jp-workman-ambassador-marketing.md](../../../../docs/format-templates/jp-workman-ambassador-marketing.md)
