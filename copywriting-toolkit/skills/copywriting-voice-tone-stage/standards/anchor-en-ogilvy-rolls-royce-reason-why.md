---
schema_version: 2.0
anchor_slug: en-david-ogilvy-reason-why-long-copy
culture: EN
quadrant: Q1
landmark: center
...
- Sentence rhythm short-then-long; declarative, subject-verb-object, Anglo-Saxon diction dominant. Short paragraphs (1-3 sentences); Latinate words reserved for product-spec precision
- Proper nouns and numbers over adjectives — "hand-rubbed twenty times" not "luxurious"; "Commander Edward Whitehead" not "our spokesman"
- Quotation marks in headlines (increased recall ~28% per his testing) — dramatize testimony
...
- "American men are beginning to realize that it is idiotic to spend $300 on a suit and then spoil the whole effect by wearing an ordinary, mass-produced shirt." (Hathaway, 1951)
- "Dove creams your skin while you wash." (Dove, 1957)
- "Dove is one-quarter cleansing cream. It creams your skin while you wash." (Dove, 1957)
- "The man from Schweppes is here." (Schweppes, 1953, Commander Edward Whitehead)
- "Schweppervescence lasts the whole drink through." (Schweppes, 1950s)
- "Guinness is good for you." (Guinness)

## Don't / Over-mimic
- **Failure mode**: LLM defaults to pastiche "mid-century adman" — stacks fake specificity ("hand-crafted in our 47-year tradition"), orotund postscripts, unearned "At X, the only sound you hear is…" parody-openers. Lists without reason-why. Tone becomes smug rather than respectful
- **Mitigation** (13 words): "One verifiable fact per claim; cut every adjective replaceable by a number or proper noun"

## Metadata
- Trigger slug: `en-david-ogilvy-reason-why-long-copy`
- Over-mimic risk: MEDIUM (long-copy mannerism risk — "At 60 miles an hour…" opener most-parodied line in advertising)
- Pairs with form: [long-form-pasona, long-form-extended, mid-form]
- Documented lineage: ✅ Ogilvy → Strunk & White (*Elements of Style* required reading per *Ogilvy on Advertising* Ch. 1); Claude Hopkins *Scientific Advertising* ("seven times")
