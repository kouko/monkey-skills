...
- Stylistic-sibling (not transferability): 李欣頻 literary-consumption (`anchor-zh-tw-lee-hsin-ping-literary-consumption.md`) — shares 1990s 意識形態 Q2 lineage + 商業文化批評 angle, but 許's `X 是一種 Y` definitional-inversion + power-disparity payload diverges structurally from 李's 排比枚舉 + antecedent-work dialogue + 具名文化座標. Mechanism-distinct per v1.12.0 cross-anchor analysis (see `docs/voice-anchor-notes/zh-tw-li-xu-stylistic-siblings-analysis.md`)
