---
schema_version: 2.0
anchor_slug: en-martin-puris-bmw-engineering-precision
culture: EN
quadrant: Q1
landmark: extreme
creator_type: named CW recast (Ammirati & Puris, BMW 1975-1996)
pilot_round: batch-7
date: 2026-04-21
---

### Martin Puris — BMW engineering-precision register (EN | Q1 extreme, named CW recast)
...
- **Ban abstract virtues in display positions** — no "excellence," "passion," "luxury," "legendary," "craftsmanship." These are failure-indicators. Substitute: a test-track lap time, a German engineer's name, a specific bolt count.
- **Long-copy architecture: spec → proof → consequence.** Paragraph 1 names a feature with its numeric value. Paragraph 2 explains the engineering problem it solves. Paragraph 3 locates the driver's physical experience of it (steering weight, turn-in crispness). Never reverse this order — emotion-first reads as Detroit.
...
- "At 55 mph, the loudest noise in the new BMW comes from the electric clock." (BMW 7-Series print, Ammirati & Puris, late 1970s — the Ogilvy Rolls-Royce line rebuilt for BMW's engineering register)
- "Unlike other luxury cars, BMW's racing heritage cannot be traced to a boardroom." (BMW 5-Series print, c. 1988)
- "An automobile that gives the cold-blooded, three-inch-thick feel of the road to drivers who like it that way." (BMW 320i print, early 1980s)
- "It took 50 engineers 5 years to improve on perfection. Herewith, the evidence." (BMW 7-Series launch, 1988 — lead-in to a full-page spec table set in body type)
- "The 3-Series. A driving machine in the truest sense of the word." (BMW 3-Series print, late 1980s)
...
- Over-mimic risk: MEDIUM (technical-spec-as-headline is widely imitated but Puris original requires genuine engineering facts; fake-precision is the failure mode)
- Pairs with form: [long-form, mid-form-brand-tagline, short-form-catchcopy]
- Recast from: BMW "The Ultimate Driving Machine" campaign anchor (v1.3.x) → named CW Martin Puris (v1.5.0)
