...
description: |
  Pick voice direction on the Authority×Affinity / Reason×Emotion quadrant, matched to anchors (Ogilvy / 許舜英 / 糸井). Use with a draft needing macro voice diagnosis before tone tuning, or a new brand voice guide. Polish → voice-tone-stage.
---
