...
- **Router multilingual trigger hooks**: appended ZH/JA trigger phrases (寫文案 / 廣告文案 / 文案發想 / コピーライティング / キャッチコピー / セールスコピー) to `using-copywriting-toolkit`'s frontmatter description, hard-wrapped ≤76 chars/line, existing English hooks unchanged.
