---
schema_version: 2.0
anchor_slug: en-lee-clow-visionary-manifesto
culture: EN
quadrant: Q2
landmark: extreme
creator_type: named ECD recast (TBWA/Chiat/Day)
pilot_round: batch-7
date: 2026-04-21
---

### Lee Clow — visionary manifesto (EN | Q2 extreme, named ECD recast)
...
- **Proper-noun citation as credential** — name historical figures by first name or iconic single name (Einstein, Gandhi, Picasso, Dylan, Earhart, Edison). Never explain who they are; the omission signals the reader is already inside the club.
- **Binary antithesis clauses** — pair opposites in single-line sentences ("You can quote them, disagree with them, glorify or vilify them. About the only thing you can't do is ignore them."). The pivot word ("but" / "because") is the rhetorical hinge.
- **Product withheld until the final beat** — 90% of the copy names no product; the brand appears only as signature or final frame. The voice earns the sign-off.
- **Short-clause descent to a single-line coda** — build with medium-length lines, resolve with a 3-to-7-word sentence that carries the whole piece's argument ("Think different.").
...
- "While some see them as the crazy ones, we see genius. Because the people who are crazy enough to think they can change the world, are the ones who do." (Apple, "Think Different," 1997 closing)
- "On January 24th, Apple Computer will introduce Macintosh. And you'll see why 1984 won't be like '1984.'" (Apple "1984" Super Bowl spot, voiceover coda, dir. Ridley Scott)
- "Hello, I'm a Mac. / And I'm a PC." (Apple, "Get a Mac," 2006-2009 — opening beat of every spot in the 66-film run)
- "Think different." (Apple tagline, 1997-2002 — coda to the manifesto)
...
- Over-mimic risk: HIGH+ (Think Different manifesto is most-parodied tech-advertising register; anaphoric "Here's to..." ubiquitous LinkedIn cliché)
- Pairs with form: [short-form-catchcopy, mid-form-brand-tagline, mid-form]
- Recast from: Apple "Think Different" campaign anchor (v1.3.x) → named ECD Lee Clow (v1.5.0)
- Credit note: actual CW for Think Different was Rob Siltanen + Ken Segall + Jennifer Golub; Clow was ECD guiding philosophy. "1984" written by Steve Hayden (Chiat/Day). "Get a Mac" written by Scott Trattner / Barton Corley team. Clow's signature is the ECD-level register selection across all three — visionary-manifesto as Apple's house voice under his stewardship.
