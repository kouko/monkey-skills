---
schema_version: 2.0
anchor_slug: en-bill-bernbach-creative-revolution
culture: EN
quadrant: Q1
landmark: toward-Q2
creator_type: named ECD (craft-gate)
pilot_round: batch-3
date: 2026-04-21
---

### Bill Bernbach — DDB Creative Revolution (EN | Q1 toward-Q2, named ECD craft-gate)
...
- **No superlatives, no exclamation marks** except as deadpan ("Lemon." period, not "Lemon!"). Forbid "best", "finest", "revolutionary", "amazing"
- **Wit is structural, never decorative** — the joke IS the argument (Avis works harder BECAUSE it is #2)
- **Address reader as peer who has seen ads before**: acknowledge skepticism implicitly by refusing to oversell
...
- "We pluck the lemons; you get the plums." (VW "Lemon", 1960)
- "Our little car isn't so much of a novelty any more." (VW "Think Small", 1959)
- "Avis is only No. 2 in rent a cars. So why go with us?" (Avis, DDB, 1962)
- "We try harder." (Avis, 1962)
- "When you're only No. 2, you try harder. Or else." (Avis, 1962)
- "I found out about Joan." (Orbach's department store, DDB, 1958)

## Don't / Over-mimic
- **Failure mode**: LLM writes performative self-deprecation — fake-humble headline ("We're not perfect, but...") followed by standard benefit pitch → schtick. Or uses "Think small"-style two-word headlines as generic template divorced from actual product disadvantage
- **Mitigation** (13 words): "Confession must name a real product flaw reader would notice unaided; no manufactured humility"

## Metadata
- Trigger slug: `en-bill-bernbach-creative-revolution`
- Over-mimic risk: MEDIUM
- Pairs with form: [short-form-catchcopy, mid-form-beaf, long-form-pasona]
- Cross-reference-valid-for: JP MEDIUM (眞木準 deadpan product-truth shares mechanic); zh-TW WEAK
