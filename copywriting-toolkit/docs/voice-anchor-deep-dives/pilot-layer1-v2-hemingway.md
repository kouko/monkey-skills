---
schema_version: 2.0
anchor_slug: en-hemingway-iceberg-minimalism
culture: EN
quadrant: Q1
landmark: toward-Q4
creator_type: author
...
### Ernest Hemingway — iceberg minimalism (EN | Q1 toward-Q4, author)
...
- Dialogue-tag density: unmarked *he said / she said* only; no *muttered / sighed / exclaimed*. Tag-less exchanges permitted once speakers established, but after ≤4-line run, re-anchor with one *said*. Do NOT chain tag-less >4 lines
- Repetition as rhythm: reuse same noun across sentences rather than pronouning or synonym-swapping (the hills / the hills / the hills)
- Iceberg clause: emotional climax stated as physical fact or refusal, not introspection. "It was a pleasant cafe. It was clean and well lighted." does the work of "he felt consoled"
...
- "Our nada who art in nada, nada be thy name thy kingdom nada thy will be nada in nada as it is in nada." ("A Clean, Well-Lighted Place", 1933)
- "In the late summer of that year we lived in a house in a village that looked across the river and the plain to the mountains." (*A Farewell to Arms*, 1929, opening)
- "'Don't let's talk. We've talked enough.' 'All right.' 'All right.'" (*A Farewell to Arms*, 1929)
- "'Oh, Jake,' Brett said, 'we could have had such a damned good time together.' … 'Yes,' I said. 'Isn't it pretty to think so?'" (*The Sun Also Rises*, 1926, closing)
- "He was an old man who fished alone in a skiff in the Gulf Stream and he had gone eighty-four days now without taking a fish." (*The Old Man and the Sea*, 1952, opening)

## Don't / Over-mimic
- **Failure mode**: LLM stacks 5-10 consecutive ≤8-word declaratives + tag-less *he said / she said* chains >4 turns, producing parody-Hemingway (recognisable Twitter joke form). Adjectives cut to zero but objects become generic (*the thing, the drink*), losing named-physical-detail discipline. Polysyndeton escalates into run-on rather than staying at 2-4 bound items
- **Mitigation** (14 words): "Name specific physical objects; cap tag-less dialogue at 4 turns; vary 6-22 word sentences"

## Metadata
- Trigger slug: `en-hemingway-iceberg-minimalism`
- Over-mimic risk: HIGH
- Pairs with form: [short-form, mid-form, long-form-extended] (NOT light-action — omission discipline incompatible with CTA-driven form)
- Cross-cultural equivalents: 谷崎潤一郎 restraint (JP, partial — different mechanism) / Raymond Carver (EN STRONG descendant) / Joan Didion (EN MEDIUM)
