---
schema_version: 2.0
anchor_slug: en-gary-halbert-dr-letter
culture: EN
quadrant: Q4
landmark: extreme
...
### Gary Halbert — direct-response letter (EN | Q4 extreme, craft-gate master)
...
- Underline key promises (print: physical; online: bold or underline). One underline per paragraph max, or emphasis dies
- Address reader as "you" from sentence one; "I" appears only to confess, admit, or stake personal credibility (losses, prison, failures, embarrassment). Third-person authority voice forbidden
- Lead with hook that is either specific dollar number, dated personal event, or outright confession ("I'm writing this from…"). Never generic benefit headline
- Specificity floor: no round numbers where odd one exists ("$2,347.19" beats "around $2,000"); named people, named places, named dates. Abstract nouns (success, freedom, wealth) must be cashed out in next sentence
...
- "Motion beats meditation." (Halbert on shipping letters vs. polishing; *Boron Letters* + newsletter)
- "People are lazy, they're skeptical, and they're bored. You have to write to all three." (*Gary Halbert Letter* archive)
- "I am writing this letter to you from a federal prison camp…" (*The Boron Letters*, 1984, Letter 1 opening — confessional hook anchoring entire correspondence)
- "If you want to know if a product will sell, don't ask people. TEST it." (*Gary Halbert Letter* newsletter)
...
- Documented lineage: Hopkins → Ogilvy → Halbert / Kennedy / Sugarman DR tradition
