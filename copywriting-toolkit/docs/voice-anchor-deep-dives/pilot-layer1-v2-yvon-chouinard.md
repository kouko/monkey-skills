---
schema_version: 2.0
anchor_slug: en-yvon-chouinard-patagonia-conscience
culture: EN
quadrant: Q2
landmark: toward-Q4
creator_type: named founder-writer recast (Patagonia, with Vincent Stanley co-authorship)
pilot_round: batch-7
date: 2026-04-21
---

### Yvon Chouinard — Patagonia conscience register (EN | Q2 toward-Q4, named founder-writer recast)
...
- Keep sentences short-to-medium (10-22 words); plain Anglo-Saxon lexicon; zero marketing abstractions ("innovative", "premium", "cutting-edge" are forbidden).
- End on a moral clause that transfers obligation to the reader ("take responsibility", "reduce, repair, reuse, recycle, reimagine") — closing on a verb of action, not a product feature.
...
- "The more you know, the less you need." (attributed to Chouinard, repeated in Let My People Go Surfing, 2005/2016; also Patagonia internal)
- "At Patagonia, we make clothes that last a long time, and we repair what breaks." (Worn Wear / Common Threads Initiative launch copy, 2011-2013)
- "Every product we make takes something from the planet we can't give back. Each piece of Patagonia clothing, whether or not it's organic or uses recycled materials, emits several times its weight in greenhouse gases, generates at least another half garment's worth of scrap, and draws down copious amounts of fresh water now growing scarce everywhere on the planet." (Common Threads Initiative letter, 2011)
- "The hardest thing in the world is to simplify your life; it's so easy to make it complex." (Let My People Go Surfing, 2005)
- "REDUCE what you buy / REPAIR what you can / REUSE what you no longer need / RECYCLE everything else / and together we REIMAGINE a world where we take only what nature can replace." (Common Threads 5R pledge, 2011)
...
- Over-mimic risk: HIGH (most-imitated sustainability-brand voice 2015-2024; "Don't Buy X" parody ubiquitous across B-Corp / DTC / outdoor categories)
- Pairs with form: [long-form, mid-form]
- Recast from: Patagonia "Don't Buy This Jacket" brand anchor (v1.3.x) → named founder-writer Yvon Chouinard + Vincent Stanley (v1.5.0)
