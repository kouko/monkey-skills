---
schema_version: 2.0
anchor_slug: en-raymond-chandler-hardboiled-metaphor
culture: EN
quadrant: Q4
landmark: toward-Q3
creator_type: author (hard-boiled)
pilot_round: batch-2
date: 2026-04-21
---

### Raymond Chandler — hard-boiled metaphor (EN | Q4 toward-Q3, author)
...
- Dialogue register = clipped + deflecting. Marlowe answers sideways, finishes others' sentences with an insult. No speech-tag decoration beyond "said / asked"
- Weather / light / room-detail as opening camera move: concrete physical register in sentence 1-2 (time of day, sky, building), character in sentence 3+. Never open on interior monologue
- Cynicism cadence = aphorism at paragraph close: flat declarative truism at end of descriptive run. One per chapter, not per paragraph
...
- "To say goodbye is to die a little." (*The Long Goodbye*, 1953)
- "There is no trap so deadly as the trap you set for yourself." (*The Long Goodbye*, 1953, Ch. 12)
- "But down these mean streets a man must go who is not himself mean, who is neither tarnished nor afraid." (*The Simple Art of Murder* essay, 1950)

## Don't / Over-mimic
- **Failure mode**: LLM defaults into simile-per-sentence cascade ("Her eyes were like X. Her voice was like Y. The room smelled like Z."). Cadence becomes pastiche within three sentences; adjective stack replaces observation. Secondary: narrator turns quippy in every line of dialogue, losing deflection quality
- **Mitigation** (13 words): "One signature simile per scene; adjectives single, not stacked; aphorism once per chapter"

## Metadata
- Trigger slug: `en-raymond-chandler-hardboiled-metaphor`
- Over-mimic risk: HIGH
- Pairs with form: [mid-form, long-form-extended, short-form]
- Cross-reference-valid-for: JP MEDIUM (大藪春彦 noir-adjacent); zh WEAK
- Suggested meta-core registry upgrade: "cap similes to 1 per scene; single adjectives only; no abstract emotional nouns in narrator voice; aphorism once per chapter max" (beyond current "1 per 50 words")
