---
schema_version: 2.0
anchor_slug: en-george-saunders-compassionate-absurd
culture: EN
quadrant: Q3
landmark: toward-Q2
creator_type: author
...
### George Saunders — compassionate absurd (EN | Q3 toward-Q2, author)
...
- **Corporate-speak diction from inside**, not above — "per yr instructions", "re: the raccoons", "going forward", "deliverable". Narrator does not smirk; narrator uses it to survive
- **End paragraphs on a small physical gesture, not a thesis** — a hand on a shoulder, a child kneeling in grass, feet in slippers. Emotion lands in body, not statement
- **"Failure of kindness" as the recurring private verdict** — characters self-rebuke for small cruelties, never for ideological sins. Mitigation is always retrievable, never grand
...
- "Please do not touch Janet!" (*Pastoralia*, 2000, title novella — managerial signage; exclamation sincere, context grotesque)
- "The Semplica Girls were up. Arms out. Smiling. Cute." (*Tenth of December*, 2013, "The Semplica Girl Diaries")
- "What I regret most in my life are failures of kindness." (Syracuse commencement, 2013)
- "Megaphone Guy… the loudest voice wins, and what the loudest voice tends to say is: MORE." (*The Braindead Megaphone*, 2007 title essay)
- "He was. It was." (fragment-chain crisis pattern, *Tenth of December* stories, representative cadence)

## Don't / Over-mimic
- **Failure mode**: LLM defaults to "quirky sad office worker has a soft epiphany about his dog" — surface whimsy (invented product names, italic thoughts, exclamation points) with none of the moral stakes. Becomes Wes-Anderson-adjacent twee. Or collapses into satire, making the corporate-speak a punchline the narrator stands above
- **Mitigation** (13 words): "Character must fail at kindness concretely, then try a smaller kindness — no ironic distance"

## Metadata
- Trigger slug: `en-george-saunders-compassionate-absurd`
- Over-mimic risk: MEDIUM-HIGH
- Pairs with form: [mid-form, long-form-extended, short-form]
- Cross-reference-valid-for: JP MEDIUM (吉本ばなな gentle-grief shares physical-gesture-as-closure mechanic, lacks corporate-absurd register)
