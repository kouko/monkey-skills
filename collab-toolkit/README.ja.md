...
v0.2.0+ は **English / 繁體中文 / 日本語** のUIラベルに対応。各 protocol に `Localized labels` テーブルがあり、3言語の role+name パターンを記載。その他のロケール (zh-CN / ko / 欧州諸言語) は部分的に動く可能性あり — 検証済みラベルを PR で追加歓迎。

アカウント言語が日本語なら protocol が自動でローカライズされたラベルとマッチします。英語/繁中アカウントでも同様。
