...
**Remediation**:
- **Shared profile mode**: log into gcal in your daily Chrome under the configured profile. Next protocol invocation picks up fresh cookies.
- **Dedicated profile mode**: `/collab-setup --reauth gcal`
