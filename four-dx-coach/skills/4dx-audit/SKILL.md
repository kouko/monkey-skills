...
- **WIG**: *From-X-to-Y-by-When* grammar (Ch 2); **Ch 7 Rule 1: one-WIG-per-individual** (cite this rule explicitly when an OKR-KR or task is being mistaken for a WIG, e.g. "ship 3 features" is a task-shaped KR violating Rule 1 — it's neither a measurable goal nor a single focused commitment); Ch 7 Rule 2: Battles-must-win-the-war; Ch 7 Rule 3: leaders veto-not-dictate; Ch 7 Rule 4: WIG must have *From X to Y by When* finish line
