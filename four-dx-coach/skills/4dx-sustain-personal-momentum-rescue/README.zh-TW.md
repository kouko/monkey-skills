...
2. **D1 — WIG 自己現在還算 wildly important 嗎？** — 不是就 route 去 `4dx-d1-personal-wig-defining`，不要在死掉的 WIG 上面重啟 D4
3. **D2 — lead** — 它真的同時 predictive 且 influenceable 嗎？lead 綠但 lag 平 = lead 選錯，route 去 `4dx-d2-personal-lead-measure-discovery`
4. **D3 — scoreboard** — 5 秒看得出勝負嗎？被收起來 / 變成 coach's-style 了 → route 去 `4dx-d3-personal-scoreboard`
...
| 情境 | 改去 |
|---|---|
| 第一次 setup 4DX | `4dx-meta-personal-strategy-triage` → `4dx-d1-personal-wig-defining` |
