...
| 状況 | 代わりの行き先 |
|---|---|
| role 明示（「自分の goal の自分の lead」） | `4dx-d2-personal-lead-measure-discovery` に直接 |
| role 明示（「team の選定を facilitate」） | `4dx-d2-team-lead-measure-facilitation` に直接 |
| role 明示（「上司から降りてきた lead」） | `4dx-d2-member-lead-measure-influence` に直接 |
...
|---|---|---|---|
| `4dx-d2-personal-lead-measure-discovery` | Solo | Discover | 2-3 個 personal lead（2 軸 + Goodhart self-check） |
| `4dx-d2-team-lead-measure-facilitation` | Team-leader | Facilitate | 2-3 個 team-owned lead（veto-not-dictate）、team WIG に整合 |
| `4dx-d2-member-lead-measure-influence` | Team-member | Influence-map | per-lead 0-5 score + 1-2 focus lead + no-influence escalation |
