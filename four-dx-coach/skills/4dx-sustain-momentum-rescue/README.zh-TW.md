...
6. **whirlwind 升級 check** — 真的有外部負荷尖峰嗎？有的話 route 到 `4dx-meta-whirlwind-triage` 重設容量，或者明確 pause WIG（明確的 pause 不算失敗）
...
| reactive / 緊急應變領域，whirlwind 本身就是工作 | 改去 `4dx-meta-whirlwind-triage`。cadence 中斷未必是問題 |
