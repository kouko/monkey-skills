...
#
# Copied from obsidian-mermaid-visualizer/scripts/validate.sh — kept in sync
# manually. This copy exists so daily-news-digest does not depend on a
# version-pinned path to another skill.
set -euo pipefail
