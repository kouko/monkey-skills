...
description: |
  ...
  design or spec work. Two modes: opportunity-space mapping (research the
  world — never interrogate the user for researchable facts) and value
  commitment (agent proposes, user ratifies). Use for: user needs / needs
  research / 使用者需求 / 使用者洞察 / ユーザーインサイト. Not for worth-it verdicts
  (business-value) nor solution design (loom-interface-design / loom-spec).
version: 0.1.0
---
