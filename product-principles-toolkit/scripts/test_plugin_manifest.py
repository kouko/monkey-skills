"""Regression guard for the product-principles-toolkit plugin manifest.
...
def test_name_is_product_principles_toolkit():
    # Why: name must match the plugin dir + marketplace source for resolution.
    assert _load()["name"] == "product-principles-toolkit"
...
def test_manifest_valid():
    ...
    for required in ("product-principles", "constitution", "principles", "portable"):
