...
`## Brief before a complex fork` in the loom-design packaged
`references/family-reception.md` contract.
...
POINTER = "references/family-reception.md §Brief before a complex fork"
