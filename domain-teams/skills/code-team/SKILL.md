...
Mindset standards are maintained locally in this plugin and loaded from the
paths named by this skill. Runtime behavior does not depend on another plugin;
new mindset additions follow `standards/mindset-extension-standard.md`.
