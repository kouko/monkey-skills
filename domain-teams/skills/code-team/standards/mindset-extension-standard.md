...
The four mindsets live only under this plugin's `standards/` directory. All
edits land here first; runtime consumers load these local files directly. No
cross-repository functional copy or same-PR synchronization is required.
...
5. **Wire it** in:
   ...
   - relevant code-team references and READMEs
