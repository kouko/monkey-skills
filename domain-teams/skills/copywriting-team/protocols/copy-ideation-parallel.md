...
5. **Parallel dispatch**: Dispatch 8 independent subagents concurrently. Each subagent outputs 8 candidates → 64 total (VS single-agent path outputs 40-80). Main worker performs no quality filtering at this stage.
