...
SSOT: scripts/canonical/loom-family/family-relay.md
...
| 💻 Merge | the one merge path: ready `gh pr merge <N> --squash --body-file <path>`, real path quoted, framed for the human to run |
