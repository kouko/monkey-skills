...
- **Validator** — `loom-design/scripts/spec/validate_spec_output.py`
- **Coverage checker** — `loom-code/scripts/check_scenario_coverage.py`
- **Living-spec index** — `loom-code/scripts/living_spec_index.py` (namespace
  membership enforced by `loom-code/scripts/check-living-spec-index.py`)
