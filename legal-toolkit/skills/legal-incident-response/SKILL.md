...
description: |
  Taiwan in-house 法務 incident response — 3-path classifier: PII-breach 個資外洩 / authority-letter 主管機關函覆 / contract-breach 合約違約. Auto-classifies a free-text incident, runs the path protocol, emits legal.md + business.md. Breach → legal-contract-review.
---
