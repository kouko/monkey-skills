...
![version](https://img.shields.io/badge/version-0.5.0-blue) ![license](https://img.shields.io/badge/license-MIT-green) ![phase](https://img.shields.io/badge/phase-3_IRAC_(SP3--a)-orange)
...
## 6 active skills（Phase 1 MVP + Phase 2 Template/Runbook + Phase 3 SP3-a IRAC、v0.5.0）

| Skill | 役割 |
|---|---|
| `using-legal-toolkit` | **Router** — 6 cluster（Playbook / Template / Runbook / IRAC / Tracker / Compliance）にわたる意図を識別、dispatch する。残る Phase 3-5 の sub-skill は not-yet-available として明示。 |
...
- **Version**：0.5.0 (2026-05-15)
- **Stability**：6 active skills（Phase 1 MVP + Phase 2 Template/Runbook + Phase 3 SP3-a IRAC issue-spot）
- **Phase**：3 SP3-a（legal-issue-spot ship）— SP3-b（legal-research）は v0.5.2 予定；v0.1.0 → v1.0.0 plan は [ROADMAP.md](ROADMAP.md) 参照
- **Test suite**：244+ tests（schema / discover / validate / detect_conflicts / abac_filter / build_baseline / seed_baseline / self_grade / grade_draft / grade_response / grade_issues / canonical drift）— `uv run --with jsonschema --with pyyaml --with pytest` で全 green
