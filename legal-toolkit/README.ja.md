...
`legal-playbook-author bootstrap` で bundled fallback → 自社 customised playbook へ移行できる。Phase 1.5 (v0.2.0) で bundled baseline を 8 clause へ拡張（LoL / Indemnification / DPA / IP-Assignment の variant-folder 版を追加）。
...
- **Stability**：pre-MVP scaffold、dogfood validation 未実施
- **Phase**：1 (MVP shell) — v0.1.0 → v1.0.0 plan は [ROADMAP.md](ROADMAP.md) 参照
