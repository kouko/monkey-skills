...
**Source brief**: docs/superpowers/specs/2026-05-16-apiclient-refactor.md
**Total tasks**: 4 (≤5 ✓)
...
- Decision: Feathers 2004 characterization path chosen over rewrite-from-scratch because code is inherited, not own-violation — code-toolkit's tdd-iron-law §Legitimate legacy-code backfill explicitly authorizes this path
