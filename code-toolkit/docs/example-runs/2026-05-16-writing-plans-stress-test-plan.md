...
- **Context paths**:
  - `/Users/kouko/GitHub/monkey-skills/.worktrees/code-toolkit-design/migrations/` (implementer reads existing migrations for naming + tool convention)
  - `/Users/kouko/GitHub/monkey-skills/.worktrees/code-toolkit-design/src/models/tenant.ts` (or equivalent — implementer locates the tenant model)
- **Acceptance**:
...
- **Context paths**:
  - `/Users/kouko/GitHub/monkey-skills/.worktrees/code-toolkit-design/src/models/tenant.ts` (tenant model + DB access pattern)
  - `/Users/kouko/GitHub/monkey-skills/.worktrees/code-toolkit-design/src/payments/` (verify directory exists or create — directory boundary only)
- **Acceptance**:
...
- **Context paths**:
  - `/Users/kouko/GitHub/monkey-skills/.worktrees/code-toolkit-design/src/payments/customer.ts` (produced by Task 2)
  - `/Users/kouko/GitHub/monkey-skills/.worktrees/code-toolkit-design/src/middleware/auth.ts` (existing auth pattern — implementer locates)
  - `/Users/kouko/GitHub/monkey-skills/.worktrees/code-toolkit-design/src/routes/` (existing route registration pattern)
- **Acceptance**:
...
- **Context paths**:
  - `/Users/kouko/GitHub/monkey-skills/.worktrees/code-toolkit-design/src/components/` (existing component convention — patterns for fetch + auth + state)
  - `/Users/kouko/GitHub/monkey-skills/.worktrees/code-toolkit-design/package.json` (verify `@stripe/react-stripe-js` + `@stripe/stripe-js` dependencies — add if missing)
- **Acceptance**:
...
- **Context paths**:
  - `/Users/kouko/GitHub/monkey-skills/.worktrees/code-toolkit-design/src/payments/customer.ts` (produced by Task 2; reuse pattern)
  - `/Users/kouko/GitHub/monkey-skills/.worktrees/code-toolkit-design/src/models/tenant.ts`
- **Acceptance**:
