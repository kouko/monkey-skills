...
claude plugin details code-toolkit           # 預期：11 skills + 1 SessionStart hook
```
...
| # | Skill | Stage | 做什麼 |
|---|---|---|---|
| Router | [`using-code-toolkit`](skills/using-code-toolkit/) | Always-on | SessionStart 自動注入；5 條 load-bearing rules + Skill Priority 表 |
