...
```
1. Install code-toolkit in your host (Claude Code or Codex CLI).
...
- [`../skills/using-code-toolkit/SKILL.md`](../skills/using-code-toolkit/SKILL.md) §Skill priority + §Red Flags — the routing the prompts test.
