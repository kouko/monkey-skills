...
# injection block injected into routed agents (code-toolkit v0.9.0 inline
# rule-sheet feature).
#
# Contract under test:
...
#
# Usage:
#   bash code-toolkit/tests/integration/test-rule-sheet-drift.sh
#
...
DISTRIBUTE="${REPO_ROOT}/code-toolkit/scripts/distribute.py"
VERIFY_DRIFT="${REPO_ROOT}/code-toolkit/scripts/verify-drift.py"
TARGET_AGENT="${REPO_ROOT}/code-toolkit/agents/implementer.md"
...
# from code-toolkit/scripts/_rule-sheet.md, no backup file needed.
