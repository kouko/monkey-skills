...
| MUST | Offer the worktree setup: `.worktrees/v2-redesign/` for the long-running branch, main checkout stays for parallel work. Cite this very repo as the worked example (this branch IS in `.worktrees/code-toolkit-design/`). |
