...
1. **Detect the package-level test command** for this project — see [`references/test-invocation-by-stack.md`](references/test-invocation-by-stack.md) (canonical invocation per language / build tool, plus detection signals).
