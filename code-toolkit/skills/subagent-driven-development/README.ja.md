...
`using-code-toolkit` が以下のいずれかを検知した時点で自動ルーティング：
...
- SDD 適用判断をしない — `using-code-toolkit` がルーティングする。
...
- [`../using-code-toolkit/SKILL.md`](../using-code-toolkit/SKILL.md) — ルーター；SDD 発火条件。
