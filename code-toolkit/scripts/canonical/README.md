# SSOT pointer — `code-toolkit/scripts/canonical/`
...
| code-toolkit functional copy | Canonical SSOT |
|---|---|
...
2. Same PR runs `code-toolkit/scripts/distribute.py` to sync functional copies.
3. CI runs `code-toolkit/scripts/verify-drift.py`; any byte diff fails the build.
