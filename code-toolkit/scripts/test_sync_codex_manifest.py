...
The Codex plugin manifest (`code-toolkit/.codex-plugin/plugin.json`) DERIVES
its shared fields from the Claude SSOT (`code-toolkit/.claude-plugin/plugin.json`)
